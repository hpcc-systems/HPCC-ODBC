...
int     ip_format_valexp(DAM_HQUERY hquery, DAM_HVALEXP hValExp, char *pSqlBuffer, int *piWriteOffset)
{
    ...
    switch (iType) {
        ...
        default:            *piWriteOffset += sprintf(pSqlBuffer + *piWriteOffset, "Invalid Value Expression Type:%d", iType);
            break;
    }
...
int     ip_format_logexp(DAM_HQUERY hquery, DAM_HLOGEXP hLogExp, char *pSqlBuffer, int *piWriteOffset)
{
    ...
    switch (iType) {
        ...
        case SQL_EXP_NOT:
            ...
            *piWriteOffset += sprintf(pSqlBuffer + *piWriteOffset, " )");
            break;
        default:            *piWriteOffset += sprintf(pSqlBuffer + *piWriteOffset, "Invalid Expression Type:%d", iType);
            break;
    }
